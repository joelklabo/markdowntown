...
[Hero] Headline + subcopy + CTAs (Start building, Browse). Right: illustrative card stack.
[Module] Featured carousel (3 cards) – badges: Staff Pick / Trending; actions: Copy, View.
[Module] Trending grid (6 cards) – stats (copies/views/votes), tags chips, quick Copy.
...
## Snippet detail
[Sticky header] Title + tags + type + stats; actions: Copy, Download, Add to builder; gated actions: Favorite, Vote, Comment (lock icon when anon).
