...
const triggerVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-mdt-pill px-3 py-2 text-sm font-medium transition duration-mdt-fast ease-mdt-emphasized border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--mdt-color-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--mdt-color-surface)]",
  {
    variants: {
      active: {
